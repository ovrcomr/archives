...
- **Generic Types, Traits and Lifetime**
  - [Removing duplication by extracting a function](./files/types_traits_lifetimes/removing_duplication.md)
  - Generic data types
    - [In function definition](./files/types_traits_lifetimes/gen_types/func_def.md)
    - [In struct definition](./files/types_traits_lifetimes/gen_types/struct_def.md)
    - [In enum definition](./files/types_traits_lifetimes/gen_types/enum_def.md)
    - [In method definition](./files/types_traits_lifetimes/gen_types/method_def.md)
    - [Performence code using generics](./files/types_traits_lifetimes/gen_types/generics.md)
  - Traits
    - [Defining a trait](./files/types_traits_lifetimes/traits/trait_def.md)
    - [Implementing a trait on a type](./files/types_traits_lifetimes/traits/trait_on_type.md)
    - [Default implementation](./files/types_traits_lifetimes/traits/default_impl.md)
    - [Traits as parameters](./files/types_traits_lifetimes/traits/trait_as_param.md)
    - [Returning Types that implement Traits](./files/types_traits_lifetimes/traits/return_trait_type.md)
    - [Using Trait bounds to conditionnally implement methods](./files/types_traits_lifetimes/traits/trait_bounds.md)
  - Validating references with Lifetimes
    - [Peventing dangling references with Lifetimes](./files/types_traits_lifetimes/lifetimes/dangling_prev.md)
    - [The borrow checker](./files/types_traits_lifetimes/lifetimes/borrow_checker.md)
    - [Generic lifetimes in function](./files/types_traits_lifetimes/lifetimes/gen_func_lifetime.md)
    - [Lifetime annotation syntax](./files/types_traits_lifetimes/lifetimes/annot_syntax.md)
    - [Lifetime annotation in function signatures](./files/types_traits_lifetimes/lifetimes/annot_func.md)
    - [Thinking in terms of Lifetimes](./files/types_traits_lifetimes/lifetimes/lifetime_thinking.md)
    - [Lifetime annotations in struct definitons](./files/types_traits_lifetimes/lifetimes/annot_struct.md)
    - [Lifetime Elision](./files/types_traits_lifetimes/lifetimes/lifetime_elision.md)
    - [Lifetime annotations in methods definitions](./files/types_traits_lifetimes/lifetimes/annot_method.md)
    - [The Static Lifetime](./files/types_traits_lifetimes/lifetimes/static_lifetime.md)
  - [Generic type parameters, Traits bounds, and Lifetimes together](./files/types_traits_lifetimes/combining_all.md)